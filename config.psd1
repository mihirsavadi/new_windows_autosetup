...
@{
    ...
    Apps = @(
        ...
        @{ Key='losslesscut'; Name='LosslessCut';            Id='ch.LosslessCut';                                                                                           Note='Lossless video trimmer. Upstream dev publishes no installer (7z portable only); winget package is community-maintained (repackaged official release) so it can lag/break - like Handy, be ready to grab it from https://github.com/mifi/lossless-cut/releases if winget fails.' }
