...
@{
    ...
    Apps = @(
        ...
        @{ Key='tectonic';   Name='Tectonic (LaTeX)';       Id='tectonic.tectonic';                                                                                   Note='Self-contained LaTeX engine (XeTeX-based); fetches packages on demand and caches them - no MiKTeX/TeXLive needed. Portable build - winget puts it on PATH via its Links folder; open a new terminal after install. LaTeX Workshop recipe is in vscode\settings.json.' }
